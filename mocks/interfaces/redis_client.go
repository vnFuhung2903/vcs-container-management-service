...
func (m *MockIRedisClient) Set(ctx context.Context, key string, value []entities.ContainerWithStatus) error {
	m.ctrl.T.Helper()
...
func (mr *MockIRedisClientMockRecorder) Set(ctx, key, value interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockIRedisClient)(nil).Set), ctx, key, value)
}
