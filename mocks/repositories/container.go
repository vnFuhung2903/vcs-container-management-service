...
// Source: vcs-container-management-service\usecases\repositories\container.go
...
import (
	...
	dto "github.com/vnFuhung2903/vcs-container-management-service/dto"
	entities "github.com/vnFuhung2903/vcs-container-management-service/entities"
	repositories "github.com/vnFuhung2903/vcs-container-management-service/usecases/repositories"
	gorm "gorm.io/gorm"
)
...
func (m *MockIContainerRepository) CreateInBatches(containers []*entities.Container) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateInBatches", containers)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateInBatches indicates an expected call of CreateInBatches.
func (mr *MockIContainerRepositoryMockRecorder) CreateInBatches(containers interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateInBatches", reflect.TypeOf((*MockIContainerRepository)(nil).CreateInBatches), containers)
}
...
func (m *MockIContainerRepository) Update(containerId string, status entities.ContainerStatus, ipv4 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", containerId, status, ipv4)
	ret0, _ := ret[0].(error)
	return ret0
}

// Update indicates an expected call of Update.
func (mr *MockIContainerRepositoryMockRecorder) Update(containerId, status, ipv4 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockIContainerRepository)(nil).Update), containerId, status, ipv4)
}
